...
\includegraphics[width=\paperwidth]{A5}%
\end{frame}
    ...
    \begin{column}{0.3\textwidth}
      \begin{center}
        \begin{tikzpicture}[scale=.3]
          \input{inputs/IntervalIsomorphisms.tex}
...
\frame[label=MO,shrink=5]{
  ...
  \begin{center}
    \includegraphics[height=2.8in]{MO-20120921}
  \end{center}
}  
