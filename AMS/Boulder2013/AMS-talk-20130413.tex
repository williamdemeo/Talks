...
% 6. HANDOUTS WITH LINES FOR NOTES:
...
\begin{frame}[label=CounterExamples]{Counterexamples}
  ...
  Of course this requires $G$ be nonabelian, but that is not sufficient.  For
  example, the eight element quaternion group is a Dedekind group.}}
