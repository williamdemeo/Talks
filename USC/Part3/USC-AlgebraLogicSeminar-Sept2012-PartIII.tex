...
% \documentclass[xcolor=dvipsnames,11pt,hide notes]{beamer}
...
% \setbeamercolor{alerted text}{fg=olivegreen,family=\rmfamily,shape=\scshape}
...
% \usepackage{ifthen}
% \newboolean{prezi}
% \setboolean{prezi}{false}
% %\setboolean{prezi}{true}
% \ifthenelse{\boolean{prezi}}{
% \setbeamersize{text margin left=3mm, text margin right=3mm}
% \setbeamertemplate{frametitle}{}
% % changes margins of all slides (useful for importing to prezi)
% }{
% %\usefonttheme{serif}
...
% \newcommand{\defn}[1]{\textcolor{olivegreen}{\textit{\textbf{#1}}}}
 ...
 \newcommand{\IE}{{\small IE}}
\title[IE Properties]{Part III: Interval Enforceable Properties \\of Finite Groups}
...
% \date[OSU-Denison 2012]{
% $31^{\mathrm{st}}$ Ohio State -- Denison \\
% Mathematics Conference\\[6pt]
% {\small May 25, 2012\\
% Columbus, Ohio}
% }
...
%\includeonlyframes{decompositions,titlepage,problem,classes,recap,method1,method2,method3,method4Short,knownresults,freese,OA,OAcong,OAEx2,PAP1,OAresults,OAextension,Limitations,OAextension2,conclusion,MO,Conclusion,SubgroupLattice,L7,L7second,IdeaOfL7Proof,OSTheorem,FinalConclusions}
%% As of 20120518 using this line:

%%% LATEST as of 2012.05.19%%%
%% \includeonlyframes{titlepage,classes,method123,knownresults,knownresultsNew,knownresultsNew2,MO,Conclusion,%
%% SubgroupLattice,IntervalIsomorphisms,ExampleOfPermutingIso,Dedekind,ProofOfIntervalIsomorphism,L7,L7second,%
%% IdeaOfL7Proof,OSTheorem,FinalConclusions}
%% \includeonlyframes{ProofOfIntervalIsomorphism}
%\includeonlyframes{Dedekind}


%%% ALL SLIDES as of 2012.05.19 %%%
%% \includeonlyframes{titlepage,problem,classes,recap,method1,method2,method123,method3Old,method4Short,method4Long,knownresults,knownresultsNew,knownresultsNew2,freese,PAP,PAP1,OAresults,OAextension,Limitations,OAextension2,conclusion,MO,Conclusion,SubgroupLattice,IntervalIsomorphisms,ExampleOfPermutingIso,Dedekind,ProofOfIntervalIsomorphism,L7second,IdeaOfL7Proof,OSTheorem,FinalConclusions}
%\includeonlyframes{Example7element,Example7elementPrezi}
%\includeonlyframes{Motivation,LocalStructure,Parachutes}


% \includeonlyframes{titlepage,Motivation,LocalStructure,Parachutes,ExamplesPrezi,Examples,Example7elementPrezi,ASClass,IEProps,IEPropsLemma,IEPropsConjecture,IEPropsLemma2,Sevens,MO,NewConclusion,SubgroupLattice,IntervalIsomorphisms,ExampleOfPermutingIso,L7second,IdeaOfL7Proof,FinalConclusions}
...
\begin{frame}[fragile,label=IntervalIsomorphisms,shrink=5]{Interval Isomorphisms}
  \begin{columns}
    \begin{column}{0.3\textwidth}
      \begin{center}
        \begin{tikzpicture}[scale=.3]
          \input{IntervalIsomorphisms.tex}
...
\vskip3mm
\hfill    \includegraphics[height=25mm]{Dedekind-stamp}
