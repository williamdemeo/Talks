...
\newcommand{\eImageOfBTwo}[1]{
  ...
  \begin{frame}[fragile,label=intro,shrink=5]{Representing lattices}
    \vskip1cm
  \begin{columns}
    ...
    \begin{column}{0.5\textwidth}
      ...
      {\bf Question:} Is this a congruence lattice?\\[5pt]

     \visible<2->{{\bf Answer:} Yes! ...of which algebra?}
    \end{column}
  \end{columns}
  ...
  \begin{columns}
    ...
    \begin{column}{0.5\textwidth}
      ...
      \visible<4->{{\bf Answer:} Yes! ...but this one is harder.}
    \end{column}
  \end{columns}}
\end{frame}


\begin{frame}[fragile,label=DWP1,shrink=5]{Construction of an algebra $\bA$ with $\Con \bA \cong L_9$.}
  ...
  \begin{columns}
    \begin{column}{0.2\textwidth}
      ...
      \begin{center}
        \begin{tikzpicture}[scale=.7]
          ...
          \input{inputs/L9Freese.tex}
          \visible<1->{\draw  (5.25,2.75) node {$L_{9}$};}
    ...
    \begin{column}{0.75\textwidth}
      ...
      \item<1-> 
        Find a permutational algebra $\bB = \<B, F\>$ with congruence lattice $\Con\bB \cong M_4$.\\[5pt]
        There are infinitely many but here's an easy one:
        \vskip6pt
        ...
        {\small
          \uncover<2->{
            \begin{itemize}
            \item
              Let $B = \{0, 1, \dots, 5\}$ index the elements of $S_3$.
              \vskip5pt
            \item the right regular action of $S_3$ on itself has
              generators $g_0 = (0,4)(1,3)(2,5)$ and $g_1 = (0,1,2)(3,4,5)$.
              \vskip5pt
            \item $\Con \<B , \{g_0, g_1\}\> \cong M_4$ has elements
              \[
        ...
        \vskip10pt
        %% \hskip-10mm
        %%     {\rmfamily {\bf Goal:} \emph{expand $\bB$ to an algebra $\bA$ that has
        %%         $\alpha$ ``doubled'' in $\Con\bA$.}}
      \item<3-> %Since $\alpha = \Cg^\bB(0,2)$, we
        Define $A = B_0 \cup B_1 \cup B_2$ where
       \vskip-8pt
       \begin{align*}
         B_0 &= \{ {\color<5->{blue}0}, 1, {\color<5->{green}2}, 3, 4, 5\}\\
         B_1 &= \{{\color<5->{blue}0}, 6, 7, 8, 9, 10\}\\
         B_2 &= \{ 11, 12, {\color<5->{green}2}, 13, 14, 15\}.
       \end{align*}
     \item<4-> Define unary operations $e_0, e_1, e_2,\, s, \,g_0 e_0$, and $g_1 e_0$.
      \end{enumerate}
    \end{column}
  \end{columns}
...
\begin{frame}[fragile,label=DWP2,shrink=5]{Construction of an algebra $\bA$ with $\Con \bA \cong L_9$.}
  \begin{columns}
...
%%%%%%%%%%%%%%% BEGIN EXPANSION & EXTENSION ANIMATIONS %%%%%%%%%%%%%%%%%%%%%%%%%5

%%---------------- EXP & EXT SLIDE 1a (abridged) -------------------------------------

\begin{frame}[fragile,label=OA-abridged-slide1,shrink=5]{Expansion \& Extension}

  %% \[\Con \< B,\{g_0, g_1\}\>\] %\\[5pt]
  %  \vskip-2pt
  %% $\alpha = |0, 1, 2|3, 4, 5|$ \hfill $\beta = |0, 3|1, 4 |2, 5|$ \hfill $\gamma = |0, 4|1, 5|2, 3|$ \hfill $\delta = |0, 5|1, 3|2, 4|$\\[5pt]
  % \input{inputs/congruences.tex}
  ...
  \begin{columns}
    ...
    \begin{column}{0.4\textwidth}
      \begin{tikzpicture}[scale=.7]          
        ...
        %% B0 rectangle %%
        \input{inputs/B0.tex} \draw  (0,-1.5) node {$B_0$};
        \draw[rounded corners,blue] (-1.5,-1) rectangle (1.5,1);

        %% B1 %%
        \input{inputs/B1.tex} \draw  (-2,2.5) node {$B_1$};
        \draw[rounded corners,dotted] (-3.5,0) rectangle (-0.5,2);

        %% B2 %%
        \input{inputs/B2.tex} \draw  (2,2.5) node {$B_2$};
        \draw[rounded corners,dotted] (3.5,0) rectangle (0.5,2);
      \end{tikzpicture}
    \end{column}
  \end{columns}
...
\begin{frame}<presentation:0>[fragile,label=OA-abridged-slide2,shrink=5]{Expansion \& Extension}
  \begin{columns}
    \begin{column}{0.3\textwidth}
      \begin{center}
        $\Con \< B,\{g_0, g_1\}\>$
  ...
  \begin{columns}
    \begin{column}{0.3\textwidth}
      \begin{itemize}
      \item<2-> $A = B_0 \cup B_1 \cup B_2$
        \vskip4pt
      \item<2->Unary operations 
        \begin{align*}
          ...
          s  & : A \twoheadrightarrow B_0
        \end{align*}
        \[g e_0 : A \stackrel{e_0}{\twoheadrightarrow} B_0 \stackrel{g}{\rightarrow} B_0\]
...
\begin{frame}<presentation:0>[fragile,label=OA-uabridged-slide1,shrink=5]{Expansion \& Extension}
  \begin{columns}
    \begin{column}{0.3\textwidth}
      \begin{center}
        $\Con \< B,\{g_0, g_1\}\>$
...
\begin{frame}<presentation:0>[fragile,label=OA-unabridged-slide2,shrink=5]{Extension \& Expansion}
...
%%%%%%%%%%%%%%%%%%%%%%% END: EXPANSION EXTENSION ANIMATIONS %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{frame}[fragile,label=OAcong,shrink=5]{Why does it work?}
  ...
  \begin{columns}
    \begin{column}{0.3\textwidth}
      \visible<7>{\begin{center}\emph{Why don't $\beta$ classes\\ of $B_1$, $B_2$ mix?}
        \end{center}
      }
    \end{column}
...
\begin{frame}<presentation:0>[fragile,label=PAP,shrink=5]{The $P^5$ Lemma}
  \begin{lemma}[\PAP]
