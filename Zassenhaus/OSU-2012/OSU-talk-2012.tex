...
\begin{tikzpicture}[scale=0.5]
    \draw (-3.5,1.25) node 
{$\Sub(G)\; \ncong$};  
    \input{tikz-inputs/NotASubG.tex}
  \end{tikzpicture}
\end{frame}
...
\begin{columns}
    \begin{column}{0.2\textwidth}
        \begin{tikzpicture}[scale=.5]
          \input{tikz-inputs/PPP.tex}
        \end{tikzpicture}
    \end{column}
    \begin{column}{0.2\textwidth}
        \begin{tikzpicture}[scale=.5]
          \input{tikz-inputs/L7plain.tex}
        \end{tikzpicture}
    \end{column}
\end{columns}
\end{frame}
...
%\begin{center}
  \begin{tikzpicture}[scale=0.5]
    \input{tikz-inputs/TwoPanel.tex}
    ...
    \begin{column}{0.2\textwidth}
      \begin{center}
        \begin{tikzpicture}[scale=.3]
          ...
          \input{tikz-inputs/L11.tex}  \draw (1,-1) node {$L_{11}$};
...
\frame[label=MO,shrink=5]{
  ...
  \begin{center}
    \includegraphics[height=2.8in]{images/MOquestion201204}
  \end{center}
}  
...
\begin{frame}[fragile,label=IntervalIsomorphisms,shrink=5]{Interval Isomorphisms}
  \begin{columns}
    \begin{column}{0.3\textwidth}
      \begin{center}
        \begin{tikzpicture}[scale=.3]
          \input{tikz-inputs/IntervalIsomorphisms.tex}
